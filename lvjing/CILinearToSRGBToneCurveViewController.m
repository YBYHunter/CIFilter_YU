//
//  CILinearToSRGBToneCurveViewController.m
//  lvjing
//
...
@interface CILinearToSRGBToneCurveViewController (){
...
@implementation CILinearToSRGBToneCurveViewController
...
- (UIImage *)transImageWithCIImage
{
    ...
    transFilter = [CIFilter filterWithName:@"CILinearToSRGBToneCurve"];
